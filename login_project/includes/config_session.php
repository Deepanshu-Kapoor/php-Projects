...
if(isset($_SESSION["last_regeneration"])){
    ...
    if(time()-$_SESSION["last_regeneration"]>=$interval){
        regenerate_session_id();// Regenerate the session ID if the interval has passed
    }
}
else{
    regenerate_session_id();// If not set, regenerate the session ID and set 'last_regeneration' timestamp
}
